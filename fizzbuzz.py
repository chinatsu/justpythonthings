        ...
        (
            ...
            dict(
                ...
                {str(x): getattr("", "join")(
                    getattr("{2}{3}{1}{1}", "format")(
                        ...
                        getattr(__import__('random'), "choice")(
                            getattr("a e i o u", "split")()))) for x in range(start, end+1) if x % 3 == 0},
                ...
                **{str(x): getattr("", "join")(
                ...
                # fizzbuzz
                **{str(x): getattr("", "join")(
                    getattr("{5}{2}{1}{1}{4}{3}{1}{1}", "format")(
                        getattr(__import__('random'), 'seed')("🅿️"),
                        chr(122),
                        getattr(__import__('random'), "choice")(
                            getattr("a e i o u", "split")()),
                        getattr(__import__('random'), "choice")(
                        ...
                        getattr(getattr(__import__('random'), "choice")(
                            getattr("b c d f g h j k l m n p q r s t v x y z", "split")()), "upper")(),
                        getattr(getattr(__import__('random'), "choice")(
                            getattr("b c d f g h j k l m n p q r s t v x y z", "split")()), "upper")())) for x in range(start, end+1) if x % 3 == 0 and x % 5 == 0},
                 # numbers
